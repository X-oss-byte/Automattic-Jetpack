 ...
 * @returns {ReactNode} - Social Icon component.
 */
const SocialIconWrapper: FC< SocialIconWrapperProps > = ( {
	className,
	fill = 'none',
	size,
	children,
...
export const FacebookIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const InstagramIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const TwitterIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const XIcon: FC< SocialIconWrapperProps > = ( { fill = 'black', size, className } ) => {
	return (
...
export const LinkedinIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const TumblrIcon: FC< SocialIconWrapperProps > = ( { fill, size, className, invert } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const GoogleIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const MastodonIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
...
export const WhatsAppIcon: FC< SocialIconWrapperProps > = ( { fill, size, className } ) => {
	return (
		<SocialIconWrapper
			fill={ fill }
			size={ size }
